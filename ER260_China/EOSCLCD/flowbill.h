...
#define  RECEIPTLOG		28		//jdb2018-08-22 打印票据文本
...
#define  LOGTYPEMAX  	28      //jdb2018-07-22 增加打印票据文本
#endif//ccr2016-06-03<<<<<<<<<<<<<<<<<<<
...
#define LOGALARMON	2048     // 当剩余空间少于此值，报警 //jdb2018-08-22
#define RECEIPTLEN      3
...
union FLOWREC
{
    ...
    struct CDC_RECEIPT			 CDC_Receipt;				//jdb2018-08-20 receipt print info
#if defined(CASE_INDIA)//ccr2016-06-03>>>>
...
short Receipt_Data(BYTE cmd);//jdb2018-08-20
